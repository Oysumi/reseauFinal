...
public class ARP {
    ...
    /**
     * @param adr adresse IP reçue
     * @return l'adresse Mac correspondant à cette adresse IP ou null si l'adresse est inconnue
     */
    ...
    /**
     * @param adr adresseMac reçue
     * @return l'adresse IP correspondant à cette adresse Mac
     * @exception AssertionError si l'adresse n'est pas connue
     */
    public Adresse get(AdresseMac adr) {
        assert (adresseConnue(adr)):"Adresse inconnue "+adr;
